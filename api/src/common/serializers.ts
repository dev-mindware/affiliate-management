...
export function planDto(p: any) {
  return {
    ...
    annual_recurring_percent: Number(p.annualRecurringPercent || 0),
...
export function subscriptionDto(s: any) {
  return {
    ...
    affiliate_nome: s.affiliate?.nomeCompleto,
    affiliate_codigo: s.affiliate?.codigoAfiliado,
    plan_id: s.planId,
